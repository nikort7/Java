 ...
 * @author Никита
 */
public class CompetitionForm extends javax.swing.JFrame {
    ...
    public CompetitionForm() {
        initComponents();
        comp.fillCompetitionJtable(CompetitionForm.jTable1, "");
         
        comp.fillCountry(jComboBoxCountry);
        comp.fillSport(jComboBoxSport);
        
        model = (DefaultTableModel)CompetitionForm.jTable1.getModel();
        CompetitionForm.jTable1.setRowHeight(35);
        CompetitionForm.jTable1.setShowGrid(true);
        CompetitionForm.jTable1.setGridColor(Color.lightGray);
        CompetitionForm.jTable1.setSelectionBackground(Color.darkGray);
    }
    ...
    private void initComponents() {
        ...
        jButtonAddCompetition = new javax.swing.JButton();
        jButtonCancel = new javax.swing.JButton();
        jButtonEditCompetition = new javax.swing.JButton();
        jScrollPane1 = new javax.swing.JScrollPane();
        jTable1 = new javax.swing.JTable();
        jLabel12 = new javax.swing.JLabel();
        jTextField_Val_Find = new javax.swing.JTextField();
        jTextFieldNameCompetiton = new javax.swing.JTextField();
        jButtonRemoveCompetiton = new javax.swing.JButton();
        ...
        jButtonAddCompetition.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jButtonAddCompetition.setText("Добавить");
        jButtonAddCompetition.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonAddCompetitionActionPerformed(evt);
            }
        });
        ...
        jButtonEditCompetition.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jButtonEditCompetition.setText("Исправить");
        jButtonEditCompetition.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonEditCompetitionActionPerformed(evt);
            }
        });
        ...
        jButtonRemoveCompetiton.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jButtonRemoveCompetiton.setText("Удалить");
        jButtonRemoveCompetiton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonRemoveCompetitonActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                    .addComponent(jButtonRemoveCompetiton, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                    .addComponent(jButtonEditCompetition))
                                .addComponent(jButtonAddCompetition, javax.swing.GroupLayout.PREFERRED_SIZE, 228, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addContainerGap()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(jButtonAddCompetition, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(14, 14, 14)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jButtonEditCompetition, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jButtonRemoveCompetiton, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButtonAddCompetitionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddCompetitionActionPerformed
        ...
        if (verifText()){
            ...
            String nameCompetition = jTextFieldNameCompetiton.getText();
            String placeCompetition = jTextFieldPlaceCompetition.getText();
            int
                id_country = 0,
                id_sport = 0;
            ...
            String dateComp = dateFormat.format(jDateChooserCompetition.getDate());

            comp.insertDeleteUpdate('i', null, id_sport, nameCompetition, id_country, placeCompetition, dateComp);
            
            jTable1.setModel(new DefaultTableModel(null, new Object[]{"ID", "Вид спорта", "Название", "Страна", "Место проведения", "Дата проведения"}));
            comp.fillCompetitionJtable(CompetitionForm.jTable1, "");

        }
    }//GEN-LAST:event_jButtonAddCompetitionActionPerformed
    ...
    private void jButtonEditCompetitionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditCompetitionActionPerformed
        ...
        if (verifText()){
            ...
            comp.insertDeleteUpdate('u', null, id_sport, nameCompetition, id_country, placeCompetition, dateComp);
            
            jTable1.setModel(new DefaultTableModel(null, new Object[]{"ID", "Вид спорта", "Название", "Страна", "Место проведения", "Дата проведения"}));
            comp.fillCompetitionJtable(CompetitionForm.jTable1, "");
            
        }
    }//GEN-LAST:event_jButtonEditCompetitionActionPerformed
    ...
    private void jButtonRemoveCompetitonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRemoveCompetitonActionPerformed
        
        int id_comp = comp.fillIDforDelete(jTextFieldNameCompetiton.getText());
        if(jTextFieldNameCompetiton.getText().equals(""))
        {
            JOptionPane.showMessageDialog(null, "Данные не выбраны.");
        }else {

            comp.insertDeleteUpdate('d', id_comp, null, null, null, null, null);

            comp.fillCompetitionJtable(jTable1, "");
            jTable1.setModel(new DefaultTableModel(null, new Object[]{"ID", "Вид спорта", "Название", "Страна", "Место проведения", "Дата проведения"}));
            comp.fillCompetitionJtable(jTable1, jTextField_Val_Find.getText());
            
            comp.fillSport(jComboBoxSport);
            jTextFieldNameCompetiton.setText("");
            comp.fillCountry(jComboBoxCountry);
            jTextFieldPlaceCompetition.setText("");
            jDateChooserCompetition.setDate(null);

        }
    }//GEN-LAST:event_jButtonRemoveCompetitonActionPerformed
    ...
    private javax.swing.JButton jButtonAddCompetition;
    private javax.swing.JButton jButtonCancel;
    public static javax.swing.JButton jButtonEditCompetition;
    private javax.swing.JButton jButtonRemoveCompetiton;
